...
**Web demo:** [![Open in Streamlit](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://your-app-name.streamlit.app)
...
2. *(họ tên thành viên 2)* — *(MSHV)*
3. *(họ tên thành viên 3)* — *(MSHV)*

**Giảng viên hướng dẫn:** TS. *(họ tên giảng viên)*
